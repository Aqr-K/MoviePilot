"""
媒体交互链：处理媒体搜索、订阅、资源选择和翻页等用户交互流程。

自 message 模块拆出独立成文件，公开导入路径经 app.chain.message 再导出保持不变。
"""
import math
import re
...
from app.helper.interaction import media_interaction_manager, PendingMediaInteraction
