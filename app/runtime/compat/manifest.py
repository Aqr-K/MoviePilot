...
MODULE_ALIASES: Dict[str, ModuleAlias] = {
    ...
    "app.modules.filemanager.storages": ModuleAlias(
        target="app.adapters.storage",
        replacement="app.adapters.storage",
        introduced="v3.0.0",
        owner="adapters",
        is_package=True,
    ),
    "app.modules.filemanager.storages.alipan": ModuleAlias(
        target="app.adapters.storage.alipan",
        replacement="app.adapters.storage.alipan",
        introduced="v3.0.0",
        owner="adapters",
    ),
    "app.modules.filemanager.storages.alist": ModuleAlias(
        target="app.adapters.storage.alist",
        replacement="app.adapters.storage.alist",
        introduced="v3.0.0",
        owner="adapters",
    ),
    "app.modules.filemanager.storages.alistgo": ModuleAlias(
        target="app.adapters.storage.alistgo",
        replacement="app.adapters.storage.alistgo",
        introduced="v3.0.0",
        owner="adapters",
    ),
    "app.modules.filemanager.storages.local": ModuleAlias(
        target="app.adapters.storage.local",
        replacement="app.adapters.storage.local",
        introduced="v3.0.0",
        owner="adapters",
    ),
    "app.modules.filemanager.storages.rclone": ModuleAlias(
        target="app.adapters.storage.rclone",
        replacement="app.adapters.storage.rclone",
        introduced="v3.0.0",
        owner="adapters",
    ),
    "app.modules.filemanager.storages.smb": ModuleAlias(
        target="app.adapters.storage.smb",
        replacement="app.adapters.storage.smb",
        introduced="v3.0.0",
        owner="adapters",
    ),
    "app.modules.filemanager.storages.u115": ModuleAlias(
        target="app.adapters.storage.u115",
        replacement="app.adapters.storage.u115",
        introduced="v3.0.0",
        owner="adapters",
    ),
