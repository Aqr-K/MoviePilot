...
MODULE_ALIASES: Dict[str, ModuleAlias] = {
    ...
    "app.modules.acoustid": ModuleAlias(
        target="app.modules.enrichment.acoustid",
        replacement="app.modules.enrichment.acoustid",
        introduced="v3.0.0",
        owner="modules",
        is_package=True,
    ),
    "app.modules.fanart": ModuleAlias(
        target="app.modules.enrichment.fanart",
        replacement="app.modules.enrichment.fanart",
        introduced="v3.0.0",
        owner="modules",
        is_package=True,
    ),
    "app.modules.listenbrainz": ModuleAlias(
        target="app.modules.enrichment.listenbrainz",
        replacement="app.modules.enrichment.listenbrainz",
        introduced="v3.0.0",
        owner="modules",
        is_package=True,
    ),
    "app.modules.lrclib": ModuleAlias(
        target="app.modules.enrichment.lrclib",
        replacement="app.modules.enrichment.lrclib",
        introduced="v3.0.0",
        owner="modules",
        is_package=True,
    ),
    "app.modules.subtitle": ModuleAlias(
        target="app.modules.enrichment.subtitle",
        replacement="app.modules.enrichment.subtitle",
        introduced="v3.0.0",
        owner="modules",
        is_package=True,
    ),
