...
class TransferJobManagerTest(unittest.TestCase):
    ...
    def test_success_callback_uses_transfer_result_target_diritem(self):
        ...
        with patch(
            "app.application.orchestration.transfer.get_chain_transfer_history_port", return_value=SimpleNamespace()
        ), patch(
    ...
    def test_manual_episode_offset_applies_once(self):
        ...
        with patch("app.application.orchestration.transfer.get_chain_transfer_history_port", return_value=transfer_history_oper), \
                patch("app.application.orchestration.transfer.get_chain_download_history_port", return_value=download_history_oper), \
    ...
    def test_failed_history_is_retried_within_retry_budget(self):
        ...
        try:
            with patch(
                ...
                "app.application.orchestration.transfer.get_chain_download_history_port",
