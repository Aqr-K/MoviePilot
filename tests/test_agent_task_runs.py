...
async def test_scheduler_agent_task_cleanup_uses_async_query(monkeypatch) -> None:
    ...
    scheduling = SimpleNamespace(remove_agent_task_job=Mock())
    monkeypatch.setattr(
    ...
    result = await AgentTaskScheduling.execute_agent_task(scheduling, task_id=42)
    ...
    scheduling.remove_agent_task_job.assert_not_called()
